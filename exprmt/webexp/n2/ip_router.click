...
c0[0] -> ar0 :: ARPResponder(192.168.1.1 00:03:1d:0c:cd:b0) -> out0;
arpq0 :: ARPQuerier(192.168.2.1, 00:03:1d:0c:cd:b0) -> out0;
c0[1] -> arpt;
arpt[0] -> [1]arpq0;
c0[2] -> Paint(1) -> ip;
...
c1[0] -> ar1 :: ARPResponder(192.168.3.2 00:03:1d:0c:cd:b0) -> out1;
arpq1 :: ARPQuerier(192.168.1.2, 00:03:1d:0c:cd:b0) -> out1;
c1[1] -> arpt;
arpt[1] -> [1]arpq1;
c1[2] -> Paint(2) -> ip;
