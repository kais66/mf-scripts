...
ssh root@node19-19 "nohup /root/mobilityfirst/mfclient/hoststack/src/mfstack -d /root/conf/stack/sender_settings >$stack_log 2>&1 &"
ssh root@node20-20 "nohup /root/mobilityfirst/mfclient/hoststack/src/mfstack -d /root/conf/stack/receiver_settings >$stack_log 2>&1 &"
...
ssh root@node20-20 "python /root/scripts/n4/httpSequenceClient.py -1 $server_ip"
